...
local Window = OrionLib:MakeWindow({IntroText = "Network Sense | Doors | Made By NetCat",Name = "Network Sense | Doors | Made By NetCat", HidePremium = false, SaveConfig = true, ConfigFolder = "DoorsSex"})
